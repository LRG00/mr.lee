...
<template name="component-name">
  <div>
    <a-button style="background:#1da979" type="primary" @click="showDrawer">
      打开播放器
    </a-button>
    <a-drawer
      :placement="placement"
      ...
      >
        ...
        <div class="play">
          ...
          <div class="m-pbar" data-action="noop">
            <div id="auto-id-aQTSW8TgDBTeJx7i" class="barbg j-flag">
              <div class="rdy">
                <a-slider
                  id="test"
                  v-model="ccc"
...
export default {
  ...
  methods: {
    ...
    updateProgress(audio) {
      ...
      this.totalTime = audio.duration ? this.transTime(audio.duration) : '00.00'
    },
    transTime(value) {
      let time = ''
